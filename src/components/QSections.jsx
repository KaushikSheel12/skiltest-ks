...
<hr className='mt-5'/>
   ...
   <div className=' py-2 px-2 h-12 w-[70%] mx-auto  mt-0   grid place-content-center items-center overflow-hidden bg-white fixed'> <button className="px-2  mb-0 py-2 w-[110px] h-9  grid place-content-center mx-auto  content-center rounded  text-black border-black bg-white">Back to Test</button></div>
