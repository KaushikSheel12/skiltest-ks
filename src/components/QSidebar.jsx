...
const QSidebar = (props) => {
 ...
 return   <div key={index} className='py-0 grid  border ' >
     <button onClick={()=>GetTheQution(el)} className='border  bg-gray-500 px-0 py-0 w-11 h-7  grid place-content-center rounded text-[white]'>
      {el.id}</button>
  </div>
})}
      </div>
