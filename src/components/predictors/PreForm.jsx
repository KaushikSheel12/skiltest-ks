  ...
  return (
    <>
      <div className="mt-20  w-full md:w-[490px] h-fit px-4 py-6 rounded-md shadow-2xl  mx-auto">
        <h4 className='text-center font-semibold text-sm md:text-md'>Enter Center Seat Allocation Board (CSAB) Details</h4>

        <p className='text-[13px] text-gray-500 mt-5'>Enter AP EAMCET Engineering Overall Rank</p>
        <input type="number" className='w-full h-8 border'/>

        <p className='text-[13px] text-gray-500 mt-5'>Local / Non-Local Status</p>
        <div className="custom-select">
          <select className='w-full h-8 border'>
            ...
            <option value="adada">Unreserved - Non local for all regions</option>
            <option value="adada">OU - Osmania University Region</option>
            <option value="adada">SVU - Sri Venkateshwara University</option>
          </select>
        </div>

        <p className='text-[13px] text-gray-500 mt-5'>Seat Type in Andhra Pradesh Counselling</p>
        <div className="custom-select">
          <select className='w-full h-8 border'>
            <option value="adada">-- Select --</option>
            <option value="adada">Disability Quota Seats</option>
            <option value="adada">Economically Weaker Section Quata Seats</option>
