...
const Design = () => {
  return (
   <>
      <>
      <div className=" md:w-[70%] w-full  mx-auto  bg-[#f4f4e9]  mt-28  md:h-[500px] h-full  border border-red-700    md:flex    ">
        <div className="imgdiv  md:w-[50%] mt-5   w-full  h-full">
          <div className=" mx-auto  md:w-[70%] border border-red-500  w-[85%] relative  mt-20 rounded-[40px] bg-blue-100 md:py-0 py-4   md:h-[440px]">
            ...
            <div className="w-[80%] px-2 py-0 md:mt-0    mt-[-40px]    h-[70px] border items-center  justify-center  rounded-lg bg-blue-900  flex gap-2  mx-auto">
                ...
                <p className='text-white font-semibold text-[17px] text-center'>Archieve  Exam Success with a Single Click now</p>
        ...
        <div className="txtdiv  md:w-[50%] w-[85%] mx-auto  md:py-0 py-6  md:px-0 px-2 mt-6 md:mt-12 md:h-full">
          ...
          Design Crafted For Exam Success , the Layout Prioritizes Ease of Use
          </p>
