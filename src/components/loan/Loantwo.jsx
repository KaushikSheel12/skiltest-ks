  ...
  return (
    <div className="w-[90%] mx-auto h-full">
      <div className="w-full h-[200px] md:h-[450px] relative">
        <div className="md:w-[550px] py-3 left-8 h-full absolute z-10 px-4 ">
          <h1 className="  mt-10 leading-10 text-white  text-[20px] md:text-[32px] font-semibold tracking-[1px]">
            Simplifying Education Loan For Abroad Studies!
          </h1>

          <div className="w-fit h-fit  mt-14  space-x-10 text-white grid md:grid-cols-2  ">
            <div className="">
              <TickBox
                icon={
                  <GiCheckMark
          ...
          <div className="w-[190px] h-[80px] mt-4 relative">
            <Image
        ...
        <div className="md:w-[440px] w-[90%] h-[550px]  px-2 py-2 right-5  md:left-[1000px]   bg-white shadow-2xl absolute  top-[50px]  rounded-2xl z-10 ">
      ...
      <div className="w-fit mt-1  grid grid-cols-3 h-fit px-4 py-2">
      ...
      <div className="w-full h-[50px]  py-2 px-20 rounded-lg shadow-lg mt-[100px]">
        <div className="flex items-center gap-20 w-fit h-fit">
          {NavItem?.map((el, i) => {
            return (
              <p
                className="text-[18px] hover:font-bold  cursor-pointer"
                key={i}
              >
                {el}
              </p>
      ...
      <p className="mt-10 text-[17px] ">
        ...
        the top options, Australia and EU nations are not far behind in terms of
        educational prospects. Getting an education loan for abroad studies is
        one of the most preferred options to finance education during the time
        of the course. For students who aspire to study abroad, many banks and
        other lenders now provide overseas education loans. Different student
        loan programmes are available from these lenders, but picking the one
        that is best for you might be challenging. We at UniCreds bridge the gap
        & help you tackle this challenge of choosing the best education loan.
        Our experts guide you to pick the most suitable competitive education
        loan available toda
      </p>

      <p className="font-semibold mt-7 text-[24px]">
      ...
      <p className="mt-10  text-[17px]">
        ...
        secured education loan, often known as a loan with collateral, requires
        the applicant to provide either material or immaterial security. A
        pledge of security to the lender may take the form of real estate, a
        fixed deposit, a life insurance policy, etc. Since the bank needs to
        confirm all the paperwork pertaining to the pledged security, this type
        of loan acceptance takes longer. However, it has lower interest rates on
        student loans, lengthier payback schedules, and no repayment throughout
        the course of school. Additionally, there is a larger likelihood that
        this education loan will be authorised, and parental income is not a
        factor in a loan acceptance.
      </p>

      <p className="mt-10  text-[17px]">
        <span className="font-semibold"> Unsecured Education Loan:</span> In the
        case of an unsecured education loan for abroad studies, the applicant is
        not required to put up any security. This is an education loan for
        abroad studies without collateral. This form of education loan is
        suitable for students who do not have any security to give. However, it
        should be noted that an unsecured education loan is more difficult to
        get approval for and has a higher rate of interest (compared to secured
        loans). Unsecured student loans also have a shorter repayment period and
        certain repayments must be made while the borrower is still in school.
        Additionally, for education loans without collateral, a minimum
        co-applicant income is required.
      </p>

      <p className="font-semibold mt-7 text-[28px]">
      ...
      <p className="font-semibold mt-7 text-[24px]">Axis Bank</p>
      <p className="mt-5  text-[17px]">
        For technical, professional, or career-oriented courses, students may
        apply for a study abroad loan in Axis Bank. Hostel costs, tuition costs,
        book costs, and other costs are covered by the loan amount, which starts
        at Rs 50,000 with competitive interest rates. With Axis Bank, the entire
        loan application process is simple.
      </p>
      <LiUlComponent heading="Key Points" items={Info1} />

      <p className="font-semibold mt-7 text-[24px]">Bank of Baroda</p>
      <p className="mt-5  text-[17px]">
        ...
        lakhs for institutions that are specifically listed and Rs. 60 lakhs for
      ...
      <p className="mt-5  text-[17px]">
        Numerous NBFCs, in addition to banks, provide education loan for abroad
        studies. NBFC frequently have fewer requirements for education loan for
        abroad eligibility.
      </p>

      <p className="font-semibold mt-20 text-[28px]">Avanse</p>
      ...
      <p className="font-semibold mt-20 text-[28px]">HDFC Credila</p>
      <p className=" text-[17px]">
        The goal of HDFC Credila, India's first specifically designed education
        loan, is to help students realise their dreams of pursuing higher
        education overseas. Credila's loan approval is available even before
        receiving official admission.
      </p>
      <NbfcBox />

      <p className="font-semibold mt-20 text-[28px]">Auxilo </p>
      <p className=" text-[17px]">
      ...
      <p className="font-semibold mt-20 text-[28px]">InCred </p>
      <p className=" text-[17px]">
      ...
      <p className="font-semibold mt-14 text-[28px]">
        Education Loan For Abroad Eligibility
      </p>
      <p className=" mt-5 text-[17px]">
        It is essential that students check if they are eligible to apply for an
        education loan for abroad studies. Although each bank or financial
      ...
      <div className="mt-10 px-2 md:px-20 relative w-full flex items-center text-white rounded-md bg-[black]  h-[150px] md:h-[350px]  ">
        <div className="w-full md:py-4  py-2 rounded-md h-full">
          ...
          <p className="md:text-[16px] md:block hidden text-[12px] md:leading-5 md:mt-5">
            ...
            the way and recommend the best partner and guide you through the
            loan applying and sanctioning process.
          </p>
      ...
      <p className=" mt-5 text-[17px]">
        ...
        application process; here are a few things that a student must do prior
        to officially applying
      </p>
