...
//   const [isSmallBoxOpen, setIsSmallBoxOpen] = useState([false, false, false]);
...
//     const updatedSmallBoxOpen = isSmallBoxOpen.map((_, i) => i === index);
//     setIsSmallBoxOpen(updatedSmallBoxOpen);
//   };
...
//  <div className="topbox  border border-red-600 w-[390px] h-[200px]"></div>
//  <div className="topbox  border border-red-600 w-[390px] h-[200px]"></div>
//  <div className="topbox   border border-red-600 w-[390px] h-[200px]"></div>

//  </div>

//    <div className="border border-green-500 flex justify-around  ">
//           {isSmallBoxOpen.map((isOpen, index) => (
//             <div
//               key={index}
//               className={`bg-teal-300 group  p-4  rounded-md  h-48 ${
//                 isOpen ? "w-[390px] h-[240px]  mt-[-20px]  " : "w-[390px] h-[100px] "
