...
const Clg = () => {
  return (
    <>
      <div className="max-w-[980px] border  h-auto mx-auto py-2 justify-between  gap-4  mt-4 flex">
        <div className="">
          <div className=" h-[500px] py-2 ">
            <div className=" md:w-full min-w-[400px]  md:mt-0 mt-[-4px]  h-56 relative rounded-r-full  ">
              <Image
            ...
            <div className="w-full flex py-2 md:mt-16  mt-10  px-2 h-10 gap-6  items-center  ">
              <div className="bg-green-600 w-20 h-1"></div>
              <div className="text-green-600  font-semibold  text-[27px] whitespace-nowrap">
                Across the U.S.
              </div>
            </div>
            <p className="py-4 text-[17px]   text-gray-500">
        ...
        <div className="w-full flex py-8 mt-   px-2 h-10 gap-6 justify-end  items-center   ">
          ...
          <div className=" md:w-full min-w-[400px] mt-16  h-56 relative rounded-l-full  ">
            <Image
              src="https://d1muf25xaso8hp.cloudfront.net/https%3A%2F%2F24e726335bbacb2fd08ed75782b1ecff.cdn.bubble.io%2Ff1643878173886x562651702202836560%2Ffood_one%25201.png?w=512&h=256&auto=compress&dpr=2&fit=max"
              fill
              alt="img1"
      ...
      <div className=" h-[500px] py-2  md:mt-0 mt-[-80px]    md:hidden block ">
        <div className=" md:w-full min-w-[400px]   h-56 relative rounded-l-full  ">
          <Image
            src="https://d1muf25xaso8hp.cloudfront.net/https%3A%2F%2F24e726335bbacb2fd08ed75782b1ecff.cdn.bubble.io%2Ff1643878173886x562651702202836560%2Ffood_one%25201.png?w=512&h=256&auto=compress&dpr=2&fit=max"
            fill
            alt="img1"
        ...
        <div className="w-full flex py-2 mt-10  px-2 h-10  justify-end   items-center  ">
          <div className="bg-green-600 w-20 h-1"></div>
          <div className="text-green-600  font-semibold    text-[27px] whitespace-nowrap">
            Across the U.S.
          </div>
