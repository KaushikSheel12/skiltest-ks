...
const Clg = () => {
  return (
    <>
      <div className="w-[80%]  h-auto mx-auto py-2 justify-center gap-4  px-2 mt-4 flex">
        <div className="w-[40%] h-[500px] py-2 px-2 ">
          <div className=" w-full h-56 relative rounded-r-full  ">
            <Image
          ...
          <div className="w-full flex py-2 mt-16  px-2 h-10 gap-6  items-center  ">
