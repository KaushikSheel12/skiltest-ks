...
const Ourpromise = () => {
  return (
    <>
      <div className="w-full h-full px-8 md:py-4  md:flex">
        <div className="md:w-[50%] w-full h-[450px] md:px-8  md:mt-0 mt-[-100px] grid place-content-center ">
          <h1 className="font-medium text-[25px] md:text-[45px] md:px-8 text-[#4e8bda]">
            Our Promise
          </h1>
          <p className="md:px-8  text-gray-600 text-md leading-6">
        ...
        <div className="md:w-fit w-full h-full   place-content-center md:grid-cols-3  grid col gap-5  px-4 py-2">
