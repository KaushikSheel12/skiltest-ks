...
<p><span className='w-1 h-1 bg-gray-600
rounded-full inline-flex mb-[4px] '></span> Attempts</p>
<p>3</p>
</div>
...
<p><span className='w-1 h-1 bg-gray-600
rounded-full inline-flex mb-[4px] mr-1'></span>Quetions</p>
<p>50</p>
</div>
...
<p><span className='w-1 h-1 bg-gray-600
rounded-full inline-flex mb-[4px] mr-1'></span>Max marks</p>
<p>100</p>
</div>
