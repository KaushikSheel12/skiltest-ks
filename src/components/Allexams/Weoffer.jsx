    ...
    <div>
      ...
      <div className='w-full md:w-[90%] border border-blue-500  h-auto  flex flex-col md:flex-row px-2 py-2 mx-auto'>
        ...
        <div className='md:w-80 h-full px-2 flex flex-row md:block overflow-x-scroll justify-between md:justify-normal'>
          ...
          <div className={`border md:w-full w-[90px]  md:h-full  h-7 md:rounded  rounded-xl mb-2 cursor-pointer hover:bg-sky-500  group  grid md:block place-content-center bg-teal-600 md:bg-white text-white`}
            ...
            <div className='hidden w-12 h-12 border rounded-full md:flex justify-center  items-center bg-[#c58af2]  text-white group-hover:bg-sky-500'>
                <GrDocumentTime size={20} className='text-white invert-[1]' color='white' /></div>
              <h2 className='font-semibold md:text-gray-500 text-white  group-hover:text-white 
  text-xs md:text-[16px]' >Test Series </h2>
            </div>
          </div>
          ...
          <div className={`border md:w-full w-[90px]  md:h-full  h-7 md:rounded  rounded-xl mb-2 cursor-pointer hover:bg-sky-500  group  grid md:block place-content-center bg-teal-600 md:bg-white text-white`}
            ...
            <div className='flex items-center gap-2 py-2 px-2'>
              <div className='hidden w-12 h-12 border rounded-full md:flex justify-center  items-center bg-[#c58af2]  text-white group-hover:bg-sky-500'>
                <BsCardChecklist size={20} color='white' /></div>
              <h2 className='font-semibold md:text-gray-500 text-white  group-hover:text-white 
            text-xs md:text-[16px]' >Quizzes </h2>
            </div>
          </div>
          ...
          <div className={`border md:w-full   md:h-full  h-7 md:rounded  rounded-xl mb-2 cursor-pointer hover:bg-sky-500  group  grid md:block place-content-center bg-teal-600 md:bg-white text-white`}
            onClick={() => handleClick(<PrevYearP />)} >
            <div className='flex items-center gap-2 py-2 px-2'>
              <div className='hidden w-12 h-12 border rounded-full md:flex justify-center  items-center bg-[#c58af2]  text-white group-hover:bg-sky-500'>
                <GiBookCover  size={20}  color='white' /></div>
              <h2 className='font-semibold md:text-gray-500 text-white  group-hover:text-white 
  text-xs md:text-[16px]' >Previous Year Papers </h2>
            </div>
          </div>
