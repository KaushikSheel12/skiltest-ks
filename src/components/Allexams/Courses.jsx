...
const Courses = () => {
  return (
   <>
     <div className='mt-8'>
  <h3 className='font-semibold md:w-[90%] border - border-red-500 md:mx-auto w-full px-2 md:py-4 py-2 md:text-[24px] text-[18px] text-center'>Start your preparation</h3>


  <div className='flex flex-row-l gap-6 flex-column md:w-[90%] md:mx-auto w-100 border border-green-500 flex-wrap justify-center items-center px-2 py-3 '>
