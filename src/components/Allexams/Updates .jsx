      ...
      <div className="mt-2">
        ...
        <div className="flex border  px-2 py-2 col-span-3 justify-center items-center gap-10  flex-wrap">
          <div className="border  w-80 h-fi rounded px-2 py-2">
            ...
            <div className="mt-2">
              {updates.map((el) =>
                el.Result.map((admitelemet, admitindex) => {
                  return (
                    <div
                      className="flex gap-2   justify-center items-center pb-2"
                      key={admitindex}
                    >
          ...
          <div className="border  w-80 h-fi rounded px-2 py-2">
            ...
            <div className="mt-2">
              {updates.map((el) =>
                el.Notifications.map((admitelemet, admitindex) => {
                  return (
                    <div
                      className="flex gap-2   justify-center items-center pb-2"
                      key={admitindex}
          ...
          <div className="border  w-80 h-[470px] rounded px-2 py-2">
            ...
            <div className="mt-2">
              {updates.map((el) =>
                el.AdmitCards.map((admitelemet, admitindex) => {
                  return (
                    <div
                      className="flex gap-2   justify-center items-center pb-2"
                      key={admitindex}
