...
<h2 className='py-2 px-2 text-red-600 font-normal'>Valid Till August 31 , 2025</h2>

<h1 className='px-2 md:text-[22px] font-semibold'>₹ 1,186</h1>

<button className='px-2  md:mt-2 rounded-md md:w-28 md:h-8 grid place-content-center bg-yellow-400 mx-auto hover:bg-black hover:text-[white] '>Take Test</button>
