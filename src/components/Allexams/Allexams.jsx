...
const Allexams = () => {
  return (
   <>
   <div className=' w-full bg-orange-600  mt-20 flex gap-0 
   border md:h-[326px] h-[300px] md:text-left text-center justify-around'>
    ...
    <div  className='text-[white] md:mx-0 mx-auto rounded w-fit  text-sm bg-orange-800  font-semibold py-2 px-4 mt-4'><p >Trusted by 3 Crore+ Students</p></div>
    </div>
