    ...
    <>
      <div className="w-full  h-28 grid grid-cols-4 gap-x-3 py-2 px-4 md:mt-16 mt-14">
        <div className=" col-span-4 md:col-span-3 ">
          ...
          {generalInstructions.instruction3.options.map((option, index) => (
            <p
              key={index}
          ...
          {generalInstructions.instruction4.options.map((option, index) => (
            <p
              key={index}
          ...
          {generalInstructions.instruction5.options.map((option, index) => (
            <p
              key={index}
              className="py-1 px-6 font-semibold  text-[#565151] text-[15px]"
            >
          ...
          {generalInstructions.rules.map((rule, index) => (
          ...
          <div className="justify-center  flex gap-5 py-2 px-4 ml-10 ">
            <button className="border  w-36 px-2 py-2 rounded bg-[#2FD5C8] hover:bg-black text-black hover:text-white  whitespace-nowrap ">
              Back to test
            </button>
            <button
              disabled={!isDisabled}
              onClick={NextButtonActive}
              className="border w-36 px-6 py-2 rounded  bg-[#2FD5C8] hover:bg-black text-black hover:text-white "
            >
              Next
            </button>
          </div>
