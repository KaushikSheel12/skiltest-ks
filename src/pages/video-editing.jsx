  ...
  return (
    <div className="w-full h-screen relative flex items-center px-6 py-1 ] ">
      ...
      <div className="w-[60%]  h-full  absolute right-[270px] px-2 ">
        ...
        <div id="Footage" className="w-full h-fit mt-7  ">
          <h2 className="text-[26px]  font-semibold">Footage</h2>
        ...
        <div id="Music-Sound" className="w-full h-fit mt-7  ">
          <h2 className="text-[26px]  font-semibold">Music & Sound</h2>
          <div className="grid grid-cols-3 gap-3 mt-4">
