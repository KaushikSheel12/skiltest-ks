...
<p className='py-1 px-4  font-semibold text-[15px]'>6: To mark a question for review, click on the Star button in top right corner of the screen. If an answer is selected (for MCQ/MCAQ) or entered (for numerical answer type) for a question that is Marked for Review , that answer will be considered in the evaluation unless the status is modified by the candidate.</p>

<p className='py-1 px-4  font-semibold text-[15px]'>7: To change your answer to a question that has already been answered, first select that question for answering and then follow the procedure for answering that type of question.</p>

<p className='py-1 px-4  font-semibold text-[15px]'>8: Note that ONLY Questions for which answers are saved or marked for review after answering will be considered for evaluation.</p>

<p  className='py-1 px-4  font-semibold text-[15px]'>9: Sections in this question paper are displayed on the top bar of the screen. Questions in a Section can be viewed by clicking on the button in lower right corner. The Section you are currently viewing</p>
...
<p className='py-1 px-4  font-semibold text-[15px]'>1. A total of 60 minutes is allotted for the examination.</p>

<p className='py-1 px-4  font-semibold text-[15px]'>2.The server will set your clock for you. In the top right corner of your screen, a countdown timer will display the remaining time for you to complete the exam. Once the timer reaches zero, the examination will end automatically. The paper need not be submitted when your timer reaches zero.</p>
